...
def ProcessPage(paper):
    ...
    columns = [[37.0 / scaling[0], 88 / scaling[1]], [155.0 / scaling[0], 88 / scaling[1]], [274.0 / scaling[0], 88 / scaling[1]], [393.0 / scaling[0], 88 / scaling[1]], [510.0 / scaling[0], 88 / scaling[1]]] #dimensions of the columns of bubbles
    radius = 3.5 / scaling[0] #radius of the bubbles
    spacing = [68.5 / scaling[0], 25 / scaling[1]] #spacing of the rows and columns
    ...
    columns = [[37.0 / scaling[0], 516 / scaling[1]], [156.0 / scaling[0], 516 / scaling[1]], [274.0 / scaling[0], 516 / scaling[1]]] #dimensions of the columns of bubbles
    radius = 3.5 / scaling[0] #radius of the bubbles
    spacing = [68.5 / scaling[0], 25 / scaling[1]] #spacing of the rows and columns 

    for k in range(0, 3): #columns
        for i in range(0, 12): #rows
            questions = []
            for j in range(0, 4): #answers
                #coordinates of the answer bubble
