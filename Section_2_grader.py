...
columns = [[37.0 / scaling[0], 45 / scaling[1]], [184.0 / scaling[0], 45 / scaling[1]], [335.0 / scaling[0], 45 / scaling[1]], [485.0 / scaling[0], 45 / scaling[1]]] #dimensions of the columns of bubbles
radius = 5 / scaling[0] #radius of the bubbles
spacing = [85.0 / scaling[0], 60.0 / scaling[1]] #spacing of the rows and columns
...
def ProcessPage(paper):
    ...
    for k in range(0, 4): #columns
        for i in range(0, 13): #rows
            questions = []
